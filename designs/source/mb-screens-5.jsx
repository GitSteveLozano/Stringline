...
function ForemanTabs({ active = 'today', fieldBadge = 2 }) {
  ...
  return (
    <>
      ...
      <div style={{position:'absolute', bottom:0, left:0, right:0, display:'flex', height:64, background:'#fff', borderTop:'1px solid #e8e3db', zIndex:5}}>
        {tabs.map(t => {
                ...
                <div key={d.d} style={{padding:'14px', borderBottom:'1px solid #e8e3db', display:'flex', alignItems:'center', gap:14, background: d.today ? 'rgba(217,144,74,.05)' : '#fff'}}>
                  ...
                  {d.p ? (
                    <>
                      ...
                      {d.conf
                        ? <span className="m-pill" data-tone="green" data-dot="true">conf.</span>
                        : <span className="m-pill" data-tone="amber" data-dot="true">tent.</span>}
                    </>
          ...
          <div className="m-btn-stack">
            ...
            <div style={{display:'flex', gap:8}}>
              <button className="m-btn" data-variant="ghost" style={{flex:1}}>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6"><path d="M1 12s4-7 11-7 11 7 11 7-4 7-11 7S1 12 1 12z"/><circle cx="12" cy="12" r="3"/></svg>
                <span style={{marginLeft:6}}>Preview</span>
              </button>
              <button className="m-btn" data-variant="quiet" style={{flex:1}}>Save as draft</button>
            </div>
          </div>
        </div>
      </div>
